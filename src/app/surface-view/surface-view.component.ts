...
export class SurfaceViewComponent {
  ...
  private createScene() {
    ...
    camera = new THREE.PerspectiveCamera(45, this.getAspectRatio(), 0.1, 500);
    camera.position.z = 5;
  }

  private getAspectRatio() {
    return this.getSurfaceWidth() / this.getSurfaceHeight();
  }
...
function prepare() {
  ...
  clickType = document.getElementById('clickType')["value"];
  console.log(window)
